...
contract('Connect4', accounts => {
    ...
    contract("Detects draw", () => {
        it ("detects draw when grid is full and no winner", async () => {
            ...
            await instance.takeTurn(0, 3, {from: accounts[1]})
            await instance.takeTurn(0, 4)
            await instance.takeTurn(0, 2, {from: accounts[1]})
            await instance.takeTurn(0, 3)
            await instance.takeTurn(0, 4, {from: accounts[1]})
            await instance.takeTurn(0, 2)
            await instance.takeTurn(0, 3, {from: accounts[1]})
            await instance.takeTurn(0, 4)
            await instance.takeTurn(0, 2, {from: accounts[1]})
            ...
            await instance.takeTurn(0, 5)
            await instance.takeTurn(0, 5, {from: accounts[1]})
            await instance.takeTurn(0, 5)
            await instance.takeTurn(0, 5, {from: accounts[1]})
            await instance.takeTurn(0, 5)
            await instance.takeTurn(0, 5, {from: accounts[1]})

            await instance.takeTurn(0, 6)
            await instance.takeTurn(0, 6, {from: accounts[1]})
            await instance.takeTurn(0, 6)
            await instance.takeTurn(0, 6, {from: accounts[1]})
            await instance.takeTurn(0, 6)

            const result = await instance.takeTurn(0, 6, {from: accounts[1]})
            assert.equal(result.logs.length, 2)
            assert.equal(result.logs[0].event, "NextMove")
